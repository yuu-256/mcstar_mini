subroutine ints7mc(init,iua,ius,natm,nl,alt,prs,tmp,nmol,cng,nptc,ins, &
...
! ius        i        device number for particle model file
...
!---Declarations
  use paras,only: kver,kptc,knl,knm0,kaw,kwlv,knv,knm1,knm2,katm
  implicit none
...
!  ratio=co2ppm/cng(1,2) !mm220227 debugged
...
! MLATMD
!--
  use paras , only : knl,knm1,knm2,katm
