subroutine ReadConfig(iui,fi,wlmin,wlmax,galbs,galbl,matm,nln,ipbf,ifrh,trh,npoly,icn,wlcn,ncomp,cnpt,mptc,vptc,icycl,np0,nx,ny,dx,dy,fis,indg,jatm,cconc,npv,llr,llu,rpvw)
  ...
  !!! EXECUTION:
  print *, 'Reading simulation settings from config file'
...
! rpvw: relative location of the viewing position on the boundary plane
  ...
  print *, 'Reading simulation settings from config file done'
